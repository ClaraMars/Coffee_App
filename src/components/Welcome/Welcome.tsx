    ...
    return (
        <section className={classes["welcome-section"]}>
            <div className={classes["welcome-text"]}>
                ...
                <p className={classes.lorem}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Qui totam at quas odit ab minima quae odio et dolorum neque facilis quos quisquam porro, exercitationem quo libero ipsa ut dolor.</p>
